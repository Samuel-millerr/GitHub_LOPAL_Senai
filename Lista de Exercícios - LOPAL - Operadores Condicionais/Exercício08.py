...
if lado_01 <= 0 or lado_02 <= 0 or lado_03 <= 0 or lado_04 <= 0:
    print("A forma é inválida! Ao menos um lado é igual ou menor que zero.")
elif lado_01 == lado_02 == lado_03 == lado_04:
